...
- **Poach back:** After cooldown, use **Poach back** to instantly re-acquire by paying the
  full first-time acquisition total (intel + approach + turn + debut, with tier multipliers)
