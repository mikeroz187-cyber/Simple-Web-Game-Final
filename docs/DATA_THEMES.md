# Data — Content Themes (Current)

This document defines the **theme catalog** used by the booking system. Themes apply to both **Promo** and **Premium** content and only modify follower / OF subscriber multipliers.
...
## Config Mapping
Values map to:
- `CONFIG.themes.mvp.theme_ids`
- `CONFIG.themes.mvp.themes.*`

`CONFIG.themes.act2.theme_ids` is currently empty.
