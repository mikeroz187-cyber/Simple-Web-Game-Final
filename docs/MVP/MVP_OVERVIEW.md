...
- **Exact trigger:** The day advances only when the player clicks the **Advance Day** UI action after the 5th confirmed booking (the shoot is locked in). The day does **not** advance from viewing content, browsing the gallery, or viewing analytics.
...
- Advance Day — manually resolve the day after the required shoots — Hub/global controls.
