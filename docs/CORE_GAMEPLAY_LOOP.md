...
- **Studio bonus visibility:** Defeating a studio grants a visible Studio Bonus (shown on Hub/Booking). Acquiring a studio also unlocks a Boss in the Gallery with a 10‑image placeholder set.
