...
## Recently Completed
- Empire Pulse Phase 2: Income particle stream, activity ticker, neon flicker & panel breathing.
...
- Empire Pulse Phase 3: Number rollers ✓, parallax depth ✓, CRT overlay (next)
